    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {pricingData.fitnessZone.map((service, index) => (
                  <div key={index} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-4">
                    ...
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{service.device}</h4>
                    <p className="text-gray-600 text-sm mb-2">{service.description}</p>
                    <p className="text-gray-500 text-sm mb-1">{service.duration}</p>
                    <p className="text-blue-700 font-bold">{service.price}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Endomasaż</h3>
              <div className="grid grid-cols-1 gap-4">
                {pricingData.cosmetologyTreatments.endomassage.map((service, index) => (
                  <div key={index} className="bg-gray-50 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">{service.title}</h4>
                    <p className="text-gray-600 text-sm mb-2">{service.details}</p>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {pricingData.hifu4d.treatments.map((treatment, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-2">{treatment.area}</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <p className="text-gray-600 text-sm">1 zabieg: {treatment.priceSingle}</p>
                  <p className="text-gray-600 text-sm">Pakiet 3 zabiegów: {treatment.pricePackage3}</p>
                  <p className="text-gray-600 text-sm">Cena za zabieg w pakiecie: {treatment.pricePerInPackage}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Suplementy</h3>
              <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Kosmetyki</h3>
              <div className="grid grid-cols-1 gap-4">
